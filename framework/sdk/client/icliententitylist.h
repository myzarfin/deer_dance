...
public:
	...
	virtual client_networkable*	get_client_networkable_from_handle(HANDLE ent)			= 0;
	virtual client_unknown*		get_client_unknown_handle(HANDLE ent)					= 0;
	virtual client_entity*		get_client_entity(int index)							= 0;
	virtual client_entity*		get_client_entity_from_handle(HANDLE ent)				= 0;
	...
	/*client_entity* get_client_entity(int index) {
		typedef client_entity* (__thiscall* OriginalFn)(PVOID, int);
		return utilities::call_vfunc<OriginalFn>(this, 3)(this, index);
	}*/
};
